...
//  pettri-ios-sdk
//
//  Created by jasonyeong790 on 03/11/2022.
//
...
class KeychainAccess {
    ...
    func getKeychainData (itemKey: String) throws -> String? {
    ...
    func getUUID() -> String? {
        ...
        if let uuid = try? keychain.getKeychainData(itemKey: uuidKey), uuid != nil {
            return uuid
        }
